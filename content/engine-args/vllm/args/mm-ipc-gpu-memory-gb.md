...
- `--mm-tensor-ipc`: транспорт мультимодальных тензоров между API- и engine-процессом; этим семафором не ограничивается — пул гейтит именно пути декодирования медиа.
